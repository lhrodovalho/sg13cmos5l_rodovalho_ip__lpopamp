...
N 200 -260 260 -260 { lab=o_m}
N 420 -260 480 -260 { lab=o_p}
...
C {devices/iopin.sym} 50 -380 2 1 {name=p_o_p lab=o_p}
C {devices/lab_pin.sym} 200 -480 2 1 {name=lavdd1 sig_type=std_logic lab=avdd}
C {p4_1.sym} 240 -320 0 0 {name=x0b[1:0]}
C {p1_4.sym} 400 -440 0 0 {name=x1a[1:0]}
C {p4_1.sym} 440 -320 0 1 {name=x1b[1:0]}
...
C {devices/lab_pin.sym} 200 -380 2 1 {name=lxp sig_type=std_logic lab=x}
...
C {devices/lab_pin.sym} 200 -260 2 1 {name=l7 sig_type=std_logic lab=o_m}
C {devices/lab_pin.sym} 480 -260 2 0 {name=l8 sig_type=std_logic lab=o_p}
C {devices/iopin.sym} 50 -350 2 1 {name=p_o_m lab=o_m}
