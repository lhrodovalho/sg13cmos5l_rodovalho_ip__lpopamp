...
C {devices/code_shown.sym} 20 -90 0 0 {name=s1 only_toplevel=false value="
X0 x g s b sg13_hv_nmos W=1.0u L=0.5u ng=1 m=1
X1 d g x b sg13_hv_nmos W=1.0u L=0.5u ng=1 m=1
"}
